...
export default function DragonModel() {
  const modelUrl = "https://storage.shakil.one/fire_dragon.glb";
  const gltf = useGLTF(modelUrl);
  //const gltf = useGLTF("/models/fire_dragon.glb");
  ...
  return (
    <>
      ...
      <ambientLight intensity={6} color={new Color(0.8, 0.85, 1)} />
...
// Preload the model
//useGLTF.preload("/models/fire_dragon.glb");

// Preload the model from R2 storage
useGLTF.preload("https://storage.shakil.one/fire_dragon.glb");
