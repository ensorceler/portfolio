    ...
    return (
        ...
        >
            ...
            <div className="flex gap-2 items-end h-max mb-8">
                ...
                <h2 className="text-xl font-bold font-medieval underline underline-offset-4 decoration-4
                dark:text-heading">
                    My Posts
                </h2>
            </div>
            <div>
                {posts.map((post) => (
                    <div key={post.id} className="mb-4">
                        <>
                            <div className="py-2">
                                <h3 className="text-lg font-manuscript md:text-xl font-semibold dark:text-title">
                                    {post.title}
                                </h3>
                                <p className="text-xs text-gray-500 dark:text-gray-400">
                                    {post.date}
                                </p>
                                <p className="text-xs md:text-sm mt-1 dark:text-gray-400">{post.description}</p>
                            </div>
                        </>
                    </div>
                ))}
